...
getMOIC <- function(data        = NULL,
                    methodslist = list("SNF", "PINSPlus", "NEMO", "COCA", "MoCluster", "LRAcluster", "ConsensusClustering", "IntNMF", "iClusterBayes"),
                    N.clust     = NULL,
  ...
  if(!all(is.element(unlist(methodslist), c("SNF", "PINSPlus", "NEMO", "COCA", "MoCluster", "LRAcluster", "ConsensusClustering", "IntNMF", "iClusterBayes")))) {
    stop("current version of MOVICS supports 10 algorithms. Allowed values contain c('SNF', 'PINSPlus', 'NEMO', 'COCA', 'MoCluster', 'LRAcluster', 'ConsensusClustering', 'IntNMF', 'iClusterBayes').")
  }
